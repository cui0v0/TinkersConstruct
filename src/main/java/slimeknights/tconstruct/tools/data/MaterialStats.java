...
final class MaterialStats {
  ...
  static {
    ...
    addMaterialStats(MaterialIds.bloodwood,
      new HeadMaterialStats(100, 4f, STONE, 1f),
      new HandleMaterialStats(0, 0.5f, 0.5f, 0.5f),
      new ExtraMaterialStats(0));
    addMaterialStats(MaterialIds.quartzite,
      new HeadMaterialStats(400, 6f, STONE, 3f),
      new HandleMaterialStats(0, 1.2f, 1.0f, 0.8f),
      new ExtraMaterialStats(0));
    ...
    addMaterialStats(MaterialIds.slimesteel,
      ...
      new HandleMaterialStats(0, 1.0f, 1.0f, 1.0f),
      new ExtraMaterialStats(0));
    addMaterialStats(MaterialIds.nauhatl,
    ...
    addMaterialStats(MaterialIds.slimebronze,
      new HeadMaterialStats(500, 10f, DIAMOND, 3f),
      new HandleMaterialStats(0, 1.3f, 1.2f, 1.0f),
      new ExtraMaterialStats(0));
    ...
    addMaterialStats(MaterialIds.soulsteel,
      ...
      new HandleMaterialStats(0, 1.0f, 1.0f, 1.0f),
      new ExtraMaterialStats(0));
    addMaterialStats(MaterialIds.obsidianbronze,
    ...
    addMaterialStats(MaterialIds.manyullyn,
      new HeadMaterialStats(1420, 14f, END, 6f),
      new HandleMaterialStats(0, 1.0f, 1.0f, 1.0f),
      new ExtraMaterialStats(0));
    addMaterialStats(MaterialIds.knightslime,
      new HeadMaterialStats(2100, 18f, END, 5f),
